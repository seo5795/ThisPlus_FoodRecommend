...
function init(){
	...
	var inputYn= "<%=inputYn%>";
	if(inputYn != "Y"){
		document.join.confmKey.value = confmKey;
		document.join.returnUrl.value = url;
		document.join.resultType.value = resultType; // resultType항목 추가(2016.10.06)
		document.join.action="https://www.juso.go.kr/addrlink/addrLinkUrl.do"; // 인터넷망
...
<body onload="init();">
	<form id="form" name="join" method="post">
