...
<body>
								...
								<div class="col-12">
									<div class="form-group">
										<textarea class="form-control w-100" name="comment"
											id="comment" cols="30" rows="9" placeholder="200자 내외 작성"></textarea>
									</div>
								</div>
							</div>
							<!-- 이미지 등록 -->
  ...
  function readImage(input) {
   ...
   document.querySelector('.form-control w-100').addEventListener('click', function(e){
       //별점 선택 안했으면 메시지 표시
       if(rating.rate == 0){
       ...
       //리뷰 5자 미만이면 메시지 표시
       if(document.querySelector('.form-control w-100').value.length < 5){
