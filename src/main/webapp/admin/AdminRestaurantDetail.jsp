					...
					<div class="col-sm-12 col-xl-6" style="min-width: 100%">
						<div class="bg-light rounded h-100 p-4">
							...
							<form name="resForm"
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="resPhone"
											name="resPhone" value="${res.resPhone}">
									</div>
								</div>
								<div class="row mb-3">
									<label for="inputCategory3" class="col-sm-2 col-form-label">카테고리</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="resCategory"
											name="resCategory" value="${res.resCategory}">
									</div>
								</div>
								<div class="row mb-3">
									<label for="inputCategory3" class="col-sm-2 col-form-label">평점</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="resRate"
											name="resRate" value="${res.resAvg}">
									</div>
								</div>
								<div class="row mb-3">
									<label for="inputAddress3" class="col-sm-2 col-form-label">주소</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="resAdd"
											name="resAdd" value="${res.resAdd}">
									</div>
								</div>
								...
								<input type="button" class="btn btn-outline-danger m-2"
									value="식당 삭제"
									onClick="location.href='adminrestaurantdelete.did?resId=${res.resId}';">
							</form>
						</div>
					</div>
