...
<body>
   ...
   <div class="resContainer">
         ...
         <form action="resupdate.do" method="post">
         	...
         	<input type="hidden" name="resAvg" value="${rdatas.resAvg}">
            <h2 class="contact-title">식당 수정</h2>
           
            
            <div class="rName">
            <h4>식당 이름</h4>
            <input name="resName" class="resName" type="text" value="${rdatas.resName}" required>
            </div>
            
         
            <div class="rCategory">
            <h4>식당 종류</h4>
            <input name="resCategory" class="resCategory" type="text" value="${rdatas.resCategory}" required>
            </div>
            
            <div class="rAdd">
            <h4>식당 주소</h4>
            <input type="text" id="resAdd" name="resAdd"  value="${rdatas.resAdd}" class="resAdd" placeholder="주소">
         ...
         <div id="map" style="width:300px;height:300px;margin-top:10px;display:none"></div>
            ...
            <div class="rPhone">
            <h4>식당 전화번호</h4>
            <input name="resPhone" class="resPhone" type="text" value="${rdatas.resPhone}" required>
            </div>
            ...
            -->
						...
						<div class="buttons">
							...
							<div class="form-group mt-3 start-button">
								<button type="submit"
									class="button button-contactForm boxed-btn">수정</button>
							</div>
							<!-- 확인 버튼 end -->
         ...
         <div class="imgPreview">
            <img src="${rdatas.resPic}" width="400px" height="300px"/>
         </div>
   </div>
